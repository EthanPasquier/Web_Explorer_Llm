...
QUESTION = "Est ce que la Camera AI Bullet de Ubiquiti est waterproof ? "
NUM_LINK = 3
...
def get_webpage_text(url):
  ...
  try :
    ...
    print(url+" est reussie")
  except :
    text_content = ""
    print(url+" est un echec")
  return text_content
...
def analyze_text(prompt):
    ...
    return index.query(prompt, llm=ChatOpenAI(model="gpt-3.5-turbo-16k",temperature=0.4))
